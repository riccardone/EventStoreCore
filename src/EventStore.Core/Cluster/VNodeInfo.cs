...
namespace EventStore.Core.Cluster {
	public static class VNodeInfoHelper {
		public static VNodeInfo FromMemberInfo(MemberInfo member, bool isPromotable, bool isClone) {
			return new VNodeInfo(member.InstanceId, 0,
				...
				member.InternalHttpEndPoint, member.ExternalHttpEndPoint, isPromotable, isClone);
		}
	}
}
