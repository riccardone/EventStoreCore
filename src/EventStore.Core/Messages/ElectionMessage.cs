...
namespace EventStore.Core.Messages
{
    public static class ElectionMessage
    {
        ...
        public class Prepare : Message
        {
            ...
            public override string ToString()
            {
                return string.Format("---- Prepare: serverId {0}, serverInternalHttp {1}, view {2}", ServerId, ServerInternalHttp, View);
            }
        }
        ...
        public class Proposal : Message
        {
            ...
            public override string ToString()
            {
                return string.Format("---- Proposal: serverId {0}, serverInternalHttp {1}, masterId {2}, masterInternalHttp {3}, "
        ...
        public class Accept : Message
        {
            ...
            public Accept(Guid serverId, IPEndPoint serverInternalHttp, Guid masterId, IPEndPoint masterInternalHttp, int view)
            {
                ServerId = serverId;
                ServerInternalHttp = serverInternalHttp;
                MasterId = masterId;
            ...
            public override string ToString()
            {
                return string.Format("---- Accept: serverId {0}, serverInternalHttp {1}, masterId {2}, masterInternalHttp {3}, view {4}",
