...
namespace EventStore.Transport.Tcp.Framing
{
    ...
    /// </summary>
    public class AmqpLengthPrefixMessageFramer : IMessageFramer
    {
        private static readonly ILogger Log = LogManager.GetLoggerFor<AmqpLengthPrefixMessageFramer>();
        ...
        /// </summary>
        public AmqpLengthPrefixMessageFramer(int maxPackageSize = 64*1024*1024)
        {
