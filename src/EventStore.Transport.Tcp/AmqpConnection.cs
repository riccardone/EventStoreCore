...
{
    public class AmqpConnection : TcpConnectionBase, ITcpConnection
    {
        ...
        public static ITcpConnection CreateConnectingAmqpConnection(Guid connectionId, 
                                                                   ...
                                                                   bool verbose)
        {
            var connection = new AmqpConnection(connectionId, remoteEndPoint, verbose);
...
// ReSharper restore ImplicitlyCapturedClosure
        ...
        public static ITcpConnection CreateAcceptedAmqpConnection(Guid connectionId, IPEndPoint remoteEndPoint, Socket socket, bool verbose)
        {
            var connection = new AmqpConnection(connectionId, remoteEndPoint, verbose);
            connection.InitSocket(socket);
            return connection;
        ...
        private AmqpConnection(Guid connectionId, IPEndPoint remoteEndPoint, bool verbose): base(remoteEndPoint)
        {
